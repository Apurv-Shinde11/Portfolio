    ...
    <header className="sticky top-0 z-50 border-b border-zinc-900/70 bg-zinc-950/70 backdrop-blur">
      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4 md:px-10 lg:px-12">
        ...
        <div className="flex items-center gap-3">
          <a
            href="#contact"
            className="group inline-flex items-center gap-2 rounded-full bg-zinc-50 px-5 py-2 text-sm font-semibold text-zinc-950 shadow-[0_0_40px_rgba(250,250,250,0.18)] transition hover:-translate-y-0.5 hover:bg-white"
          >
            Contact
            <span
              aria-hidden
